export const sampleChats = [
  {
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=John"],
    name: "Leana Brown",
    _id: "1",
    groupChat: false,
    members: ["1", "2"],
  },
  {
    ...
    groupChat: false,
    members: ["1", "2"],
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=Riley"],
  },
  {
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=James"],
    name: "James Wilson",
    _id: "3",
    groupChat: false,
    members: ["1", "2"],
  ...
  {
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=Andrew"],
  ...
  {
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=David"],
    name: "David Thompson",
    _id: "5",
    groupChat: false,
    members: ["1", "2"],
  ...
  {
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=Michael"],
    name: "Michael Garcia",
    _id: "6",
    groupChat: false,
    members: ["1", "2"],
  ...
  {
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=Robert"],
    name: "Robert Lee",
    _id: "7",
    groupChat: false,
    members: ["1", "2"],
  ...
  {
    avatar: ["https://api.dicebear.com/8.x/adventurer/svg?seed=Daniel"],
...
export const sampleDashboardData = {
  users: [
    ...
    {
      _id: 9,
      avatar: "https://api.dicebear.com/8.x/adventurer/svg?seed=Matthew",
      username: "Matthew",
      name: "Matthew Taylor",
      email: "matthew@kmail.com",
      friends: 13,
      groups: 3,
    ...
    {
      _id: 10,
      avatar: "https://api.dicebear.com/8.x/adventurer/svg?seed=Christopher",
      username: "Christopher",
      name: "Christopher Martinez",
      email: "christopher@kmail.com",
      friends: 14,
      groups: 5,
